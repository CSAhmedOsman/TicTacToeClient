...
public  class LobbyScreenUI extends AnchorPane {
    ...
    protected static ListView playerListView;

    // My Work
   // private static  ListView<HBox> playerListView;
...

    {
        ...
        textArea.setStyle("-fx-textColor: black;");
        ...
        btnSend.setStyle("-fx-background-color: #FD6D84;");
        ...
        playerListView.setStyle("-fx-background-color: #43115b;");
