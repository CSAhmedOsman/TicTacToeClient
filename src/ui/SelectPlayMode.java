...
public class SelectPlayMode extends Pane {
    ...
    public SelectPlayMode() {
        ...
        btnOnlie.setStyle("-fx-background-radius: 30; -fx-background-color: #fff7f7;");
        btnOnlie.setText("VS");
    ...
    protected void addEventHandlers() {
        ...
        btnWithPc.setOnAction((e) -> {
            Parent root = new SelectGameLevel();
            Scene scene = new Scene(root);
            ClientApp.stage.setScene(scene);
            ClientApp.stage.show();
        });
